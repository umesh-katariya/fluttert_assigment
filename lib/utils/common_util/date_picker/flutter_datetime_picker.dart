...
//    print('refreshScrollOffset ${widget.pickerModel.currentRightIndex()}');
  ...
  //Header View
  Widget _renderHeaderView(DatePickerTheme theme) {
    return Container(
      ...
      child: Text(theme.headerText,style: theme.headerStyle),
    );
  }
  ...
  Widget _renderTitleActionsView(DatePickerTheme theme) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: theme.titleColor ?? theme.backgroundColor,
      ),
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: <Widget>[
          ...
          Container(
            ...
            child: CupertinoButton(
              pressedOpacity: 0.3,
              padding: EdgeInsets.only(right: 26, top: 0),
              child: Text(
                '$done',
...
class _BottomPickerLayout extends SingleChildLayoutDelegate {
  ...
  BoxConstraints getConstraintsForChild(BoxConstraints constraints) {
    ...
    if (showTitleActions == true) {
      maxHeight += theme.titleHeight+theme.headerHeight;
    }
